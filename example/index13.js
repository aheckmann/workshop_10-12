 ...
 * 13) render latest stocks emitted from event bus using middleware
 */

var routes = require('./routes/index6')
var middleware = require('./lib/middleware/middleware2')
var latestStocks = require('./lib/middleware/latestStocks')
